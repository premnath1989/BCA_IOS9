...
@interface SIResubmissionListing : UIViewController<UITableViewDelegate, UITableViewDataSource,ReaderViewControllerDelegate, siListingDelegate, SIDateDelegate, NDHTMLtoPDFDelegate, SSZipArchiveDelegate, ProgressBarDelegate>
{
...
- (IBAction)btnResubmit:(id)sender;
