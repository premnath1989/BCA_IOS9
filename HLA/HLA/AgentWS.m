...
{
	return [[[AgentWSSoapBinding alloc] initWithAddress:@"http://192.168.2.131/AgentWebService/AgentWS.asmx"] autorelease];
}
+ (AgentWSSoap12Binding *)AgentWSSoap12Binding
{
	return [[[AgentWSSoap12Binding alloc] initWithAddress:@"http://192.168.2.131/AgentWebService/AgentWS.asmx"] autorelease];
}
@end
