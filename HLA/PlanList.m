...
- (void)viewDidLoad
{
	...
	if([TradOrEver isEqualToString:@"TRAD"]){
        ...
        ListOfPlan = [[NSMutableArray alloc] initWithObjects:@"BCA Life Heritage Protection",@"BCA Life Keluargaku",@"BCA Life Heritage Protection – For BCA Staff",@"BCA Life Unit Linked",nil];
